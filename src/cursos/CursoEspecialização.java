...
public class CursoEspecialização extends Curso{
    boolean gradeCurricular;
    public CursoEspecialização(String nome, String formacao, String duracao, String tipo, int valor, boolean gradeCurricular) {
